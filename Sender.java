...
{  
  ...
  public JPanel senderPanel(){
    ...
    //imageicon
    ImageIcon image=new ImageIcon("pexels-pixabay-220453.jpg");
    ...
    //videoicon
    ImageIcon videoicon=new ImageIcon("video-camera-alt.png");
    JLabel videolabel=new JLabel(resizeIcon(videoicon, 30, 30));
    
    //voicecallicon
    ImageIcon voiceicon=new ImageIcon("phone-call.png");
    JLabel voicelabel=new JLabel(resizeIcon(voiceicon, 25,25));

    //doticon
    ImageIcon doticon=new ImageIcon("menu-dots-vertical.png");
  ...
  public void addMessage(String message,boolean isSender)
  {
   ...
   messageLabel.setBackground(isSender? new Color(0,128,128):new Color(255, 224, 189));
